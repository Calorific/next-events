...
export const LoginButton: FC = () => {
  ...
  return (
    <button className="flex gap-x-[10px] items-center" onClick={() => router.push('/api/auth/signin')}>
      Войти
      <svg className="rotate-180" width="20px" height="20px" viewBox="0 -6.5 36 36" version="1.1" xmlns="http://www.w3.org/2000/svg">
