...
export const Logout: FC<LogoutProps> = ({ name }) => {

  return <button className="flex gap-x-[10px] items-center" onClick={() => signOut()}>
    {name}
    <svg width="20px" height="20px" viewBox="0 -6.5 36 36" version="1.1" xmlns="http://www.w3.org/2000/svg">
